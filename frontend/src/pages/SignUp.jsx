        ...
        <div className='w-full max-w-6xl bg-[var(--bg-surface)] shadow-2xl rounded-[32px] flex flex-col md:flex-row overflow-hidden border border-[var(--border-color)] min-h-[650px]'>
            ...
            <div className='w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-[var(--bg-surface)] relative z-10'>
                <div className='w-full max-w-md mx-auto space-y-8'>
                    ...
                    <form className='space-y-5' onSubmit={(e)=>e.preventDefault()}>
                        ...
                        <div className='space-y-2 pt-2'>
                           ...
                           <div className='flex items-center gap-3'>
                              <button type="button" className={`flex-1 py-3 px-4 rounded-xl font-bold transition-all border ${role === 'student' ? "bg-blue-50 dark:bg-blue-500/10 text-blue-600 border-blue-200 dark:border-blue-500/30" : "bg-[var(--bg-main)] text-[var(--text-muted)] border-[var(--border-color)] hover:border-blue-300"}`} onClick={()=>setRole("student")}>
                                Student
                              </button>
                              <button type="button" className={`flex-1 py-3 px-4 rounded-xl font-bold transition-all border ${role === 'educator' ? "bg-blue-50 dark:bg-blue-500/10 text-blue-600 border-blue-200 dark:border-blue-500/30" : "bg-[var(--bg-main)] text-[var(--text-muted)] border-[var(--border-color)] hover:border-blue-300"}`} onClick={()=>setRole("educator")}>
                                Educator
                              </button>
                           </div>
                        </div>
                    ...
                    <button className='w-full bg-[var(--bg-main)] border-2 border-[var(--border-color)] hover:border-blue-500/30 hover:bg-blue-50/50 dark:hover:bg-blue-900/10 text-[var(--text-main)] py-3.5 rounded-xl font-bold flex justify-center items-center gap-3 transition-all' onClick={googleSignUp}>
