...
const sendMail = async (to, otp) => {
    try {
        ...
        console.log(`[Mail] OTP sent to ${to}: ${info.messageId}`);
    } catch (error) {
...
export const sendApprovalEmail = async (to, courseTitle, studentName, studentId) => {
    try {
        ...
        console.error(`[Mail Error] Failed to send Approval email to ${to}:`, error);
        throw error;
    }
};
...
export const sendApplicationReceivedEmail = async (email, name) => {
    try {
        ...
        console.log(`[Mail] Application confirmation sent to ${email}`);
    } catch (error) {
        console.error(`[Mail Error] Failed to send Application confirmation to ${email}:`, error);
        throw error;
    }
};
...
export const sendSetPasswordEmail = async (email, name, setPasswordLink) => {
    try {
        ...
        console.log(`[Mail] Set password link sent to ${email}`);
    } catch (error) {
        console.error(`[Mail Error] Failed to send Set password link to ${email}:`, error);
        throw error;
    }
};
...
export const sendTrainerRejectionEmail = async (email, reason, name) => {
    try {
        ...
        console.log(`[Mail] Rejection email sent to ${email}`);
    } catch (error) {
        console.error(`[Mail Error] Failed to send Rejection email to ${email}:`, error);
        throw error;
    }
};
...
export const sendVolunteerSubmissionEmail = async (email, name) => {
    try {
        ...
        console.log(`[Mail] Volunteer sub confirmation sent to ${email}`);
    } catch (error) {
        console.error(`[Mail Error] Failed to send Volunteer sub confirmation to ${email}:`, error);
        throw error;
    }
};
...
export const sendVolunteerApprovalEmail = async (email, name) => {
    try {
        ...
        console.log(`[Mail] Volunteer approval sent to ${email}`);
    } catch (error) {
        console.error(`[Mail Error] Failed to send Volunteer approval to ${email}:`, error);
        throw error;
    }
};
